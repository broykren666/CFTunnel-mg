...
- **中文界面**：全中文交互，针对 Windows/Linux/macOS 深度优化。
...
- **Linux/macOS**: 标准终端即可，执行安装/更新时可能需要 sudo 权限。
...
- **管理员权限**：在 Windows 上建议以“管理员身份”运行终端，以便成功安装系统服务。
- **换行符**：脚本强制使用 **LF** 换行符。如需手动编辑，请使用 Notepad4, VS Code 或 Vim。
